...
from src.tools.api_original import _make_api_request, get_prices

class TestRateLimiting:
    """Test suite for API rate limiting functionality."""

    @patch('src.tools.api_original.time.sleep')
    @patch('src.tools.api_original.requests.get')
    ...
    @patch('src.tools.api_original.time.sleep')
    @patch('src.tools.api_original.requests.post')
    ...
    @patch('src.tools.api_original._cache')
    @patch('src.tools.api_original.time.sleep')
    @patch('src.tools.api_original.requests.get')
